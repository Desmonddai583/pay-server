 ...
 * 短信相关
 * */
const accessKeyId = 'LTAIW47GhXAeb6oY'
const secretAccessKey = 'W2FWmU4hPQ2qoThyjqklIVSQW66Ov1'
const sign_name = 'desmonddai58'

const tp1 = 'SMS_170520680' // 注册模板

const sendSms = async (mobile_phone, code, type) => {
  	// 直接返回true 默认验证码为 000000，生产环境请注释掉下行
  	return true;
  	// 生产环境注释掉上行
