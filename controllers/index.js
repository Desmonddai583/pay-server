...
const init = {
    getAllRouters(app, router, socket, event) {
        app.use(router(_ => {
            ...
            _.post('/api/user/update_pwd', usersController.updatePwd())// 修改密码
